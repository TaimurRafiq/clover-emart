			...
			<div class="row">
				<div class="col-lg-3 order-lg-1">
                    ...
                    curl_setopt_array($curl, array(
                      CURLOPT_URL => $base_url."api/Products/GetProducts?BrandID=null&CategoryID=$catid&pageNumber=1&pageSize=10&isPagination=false",
				...
				<div class="col-lg-9 order-1 order-lg-2 mb-sm-35 mb-xs-35">
                    ...
                    curl_setopt_array($curl, array(
	                    CURLOPT_URL => $base_url."api/Products/GetProducts?BrandID=null&CategoryID=$catid&pageNumber=null&pageSize=null&isPagination=false",
	                    CURLOPT_RETURNTRANSFER => true,
	                    CURLOPT_TIMEOUT => 30,
	                    CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
	                    CURLOPT_CUSTOMREQUEST => "GET",
                    ...
                    curl_setopt_array($curl, array(
                      	CURLOPT_URL => $base_url."api/Products/GetProducts?BrandID=null&CategoryID=$catid&pageNumber=$page&pageSize=$item_perpage&isPagination=true",
                      	CURLOPT_RETURNTRANSFER => true,
                      	CURLOPT_TIMEOUT => 30,
                      	CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
                      	CURLOPT_CUSTOMREQUEST => "GET",
								...
								<div class="image">
									...
									<div class="product-content">
										<div class="product-categories">
											...
											<a href="#l"><?php echo $value['Category']; ?></a>
										</div>
										...
										<ul>
										    <?php if(isset($_GET['category_id'])){ ?>
    											<!-- first page -->
                          						<?php if($page >= 3){ ?>
    						                        <li class="page-item">
    						                          <a class="page-link" href="?category_id=<?php echo $catid ?>&page=<?php echo $startpage ?>" tabindex="-1" aria-label="Previous">
    						                           &laquo;
    						                    ...
    						                    <?php } ?>
    					                      	...
    					                      	<?php if($page != $startpage){ ?>
    					                        	<li class="page-item"><a class="page-link" href="?category_id=<?php echo $catid ?>&page=<?php echo $previouspage ?>"><i class="fa fa-angle-left"></i></a></li>
    					                      	<?php } ?>
    
    					                      	<?php if($page >= 2){ ?>
    					                        	<li class="page-item"><a class="page-link" href="?category_id=<?php echo $catid ?>&page=<?php echo $previouspage ?>"><?php echo $previouspage ?></a></li>
    					                      	<?php } ?>
    
    
    					                      	<!-- current page -->
    					                      	<li class="page-item active"><a class="page-link" href="?category_id=<?php echo $catid ?>&page=<?php echo $page ?>"><?php echo $page ?></a></li>
    
    
    					                      	<!-- next page -->
    					                      	<?php if($page != $endpage){ ?>
    					                        	<li class="page-item"><a class="page-link" href="?category_id=<?php echo $catid ?>&page=<?php echo $nextpage ?>"><?php echo $nextpage ?></a></li>
    					                      	<?php } ?>
    
    					                      	<?php if($page != $endpage){ ?>
    					                        	<li class="page-item"><a class="page-link" href="?category_id=<?php echo $catid ?>&page=<?php echo $nextpage ?>"><i class="fa fa-angle-right"></i></a></li>
    					                      	<?php } ?>
    					                      	...
    					                      	<?php if($page != $endpage){ ?>
    					                        	<li class="page-item">
    					                          		<a class="page-link" href="?category_id=<?php echo $catid ?>&page=<?php echo $endpage ?>" aria-label="Next">
