		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					...
					<br>
					<p>Our customers can cancel orders when they receive confirmation call after submitting online order. It normally takes 2-3 hours to give you a confirmation call from our customer representative.</p>
				</div>
			</div>
		</div>
	</div>
