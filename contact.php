...
if(isset($_POST['submit']))
{
        ...
        $mail->setFrom($_POST['customerEmail'],$_POST['customerName']);
        $mail->FromName = "Contact Form";
        $mail->addAddress('cloveremart.contact@gmail.com');
        ...
        //$mail->Body='<br>Customer Name : '.$first_name.'<br>Customer Email : '.$email.'<br>Subject : '.$subject.'<br>Message : '.$message.'<br>';
        $mail->Body='<table rules="all" style="border-color: #666;" cellpadding="10"><tr style="background: #eee;"><td><strong>Name:</strong> </td><td>'.$first_name.'</td></tr><tr><td><strong>Email:</strong> </td><td>'.$email.'</td></tr><tr><td><strong>Subject:</strong> </td><td>'.$subject.'</td></tr><tr><td><strong>Message:</strong> </td><td>'.$message.'</td></tr>';
...
<body>
				...
				<div class="col-lg-3 col-md-4 mb-xs-35">
					...
					<div class="contact-page-side-content">
						...
						<div class="single-contact-block">
							...
							<p>24-C Khayaban-e-Nishat,DHA Ph-6,Karachi,Pakistan</p>
						</div>
    ...
    <!-- Google Map -->
	<script src="https://maps.google.com/maps/api/js?sensor=false&libraries=geometry&v=3.22&key=AIzaSyCBRKBi3jKCTKCp4wjjtaKWYy_WLWPNWM4"></script>
    ...
    <script>
        ...
        function init() { 
            ...
            var mapOptions = {
                ...
                center: new google.maps.LatLng(24.800268, 67.055628), // New York24.800268, 67.055628
            ...
            var marker = new google.maps.Marker({
                position: new google.maps.LatLng(24.800268, 67.055628),
                map: map,
                title: 'Greenfarm',
