			...
			<div class="row">
				...
				<div class="col-lg-9 order-1 order-lg-2 mb-sm-35 mb-xs-35">
                    ...
                    if(!empty($catid)){
                      ...
                      CURLOPT_URL => $base_url."api/Products/GetProducts?BrandID=$catid&CategoryID=null",
                      ...
                      curl_setopt_array($curl, array(
                      CURLOPT_URL => $base_url."api/Products/GetProducts?BrandID=null&CategoryID=null",
                      CURLOPT_RETURNTRANSFER => true,
                      CURLOPT_TIMEOUT => 30,
                      CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
                      CURLOPT_CUSTOMREQUEST => "GET",
								...
								<div class="image">
									...
									<div class="product-content">
										<div class="product-categories">
											<a href="shop-left-sidebar.html"><?php echo $value['BRandTitle']; ?></a>,
											<a href="shop-left-sidebar.html"><?php echo $value['Category']; ?></a>
										</div>
