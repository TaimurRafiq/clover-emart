...
.pro-qty input {
				...
				<div class="col">
					<div class="breadcrumb-container">
						<ul>
							...
							<li class="active">Search Product By -> <?php echo $searchProduct; ?></li>
						</ul>
					</div>
				</div>
			</div>
	...
	<div class="shop-page-container mb-50">
			...
			<div class="row">
				<div class="col-lg-12 mb-sm-35 mb-xs-35">
                    ...
                    curl_setopt_array($curl, array(
                      CURLOPT_URL => $base_url."api/Products/GetProductsByText?searchText=$searchProduct",
     ...
     //                $getProducts_id = array();
					// foreach ($datasearch as $value1) {
					// 	if(!in_array($value1['ProductID'], $getProducts_id)){
					// 		array_push($getProducts_id, $value1['ProductID']);
					// 	}
					// }
					...
					<div class="shop-product-wrap grid row no-gutters mb-35">
                        <?php
                        	foreach ($datasearch as $value) {
                        		// if(in_array($value['ProductID'], $getProducts_id)){
                        ?>
										...
										<div class="gf-product shop-grid-view-product">
											<div class="image">
												...
												<div class="product-content">
													...
													<h3 class="product-title"><?php echo $value['ProductName']; ?></h3>
													<div class="price-box">
...
function addtocart(id){
	...
	$.ajax({
		...
		success:function(data){
			$( ".shopping-cart" ).load( "search-product.php .shopping-cart" );
