				...
				<div class="col">
					<div class="breadcrumb-container">
						<ul>
							...
							<li><a href="shop-left-sidebar.php?category_id=<?php echo $catid ?>"><i class="fa fa-list-alt"></i> Category</a></li>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-3 order-2 order-lg-1">
					...
					<div class="hero-side-category">
						...
						<div class="category-toggle-wrap">
							<!-- Category Toggle -->
							<button class="category-toggle"> <span class="arrow_carrot-right_alt2 mr-2"></span> All Brands</button>
						</div>
							...
							<ul id="brandList">
								...
								foreach ($datab as $value) {
									...
									if($value['CategoryID'] == $catid){
										if(!in_array($value['BrandID'], $brand_arr)){
				                    		array_push($brand_arr, $value['BrandID'])
								?>
											<li><a href="shop-left-sidebar-brand.php?category_id=<?php echo $value['CategoryID']; ?>&brand_id=<?php echo $value['BrandID']; ?>"><?php echo $value['BRandTitle']; ?> </a></li>
								<?php 
										}
									}
								} ?>
				...
				<div class="col-lg-9 order-1 order-lg-2 mb-sm-35 mb-xs-35">
                    ...
                    curl_setopt_array($curl, array(
	                    CURLOPT_URL => $base_url."api/Products/GetProducts?BrandID=$brandid&CategoryID=$catid&pageNumber=null&pageSize=null&isPagination=false",
	                    CURLOPT_RETURNTRANSFER => true,
	                    CURLOPT_TIMEOUT => 30,
	                    CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
	                    CURLOPT_CUSTOMREQUEST => "GET",
                    ...
                    curl_setopt_array($curl, array(
                      	CURLOPT_URL => $base_url."api/Products/GetProducts?BrandID=$brandid&CategoryID=$catid&pageNumber=$page&pageSize=$item_perpage&isPagination=true",
                      	CURLOPT_RETURNTRANSFER => true,
                      	CURLOPT_TIMEOUT => 30,
                      	CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
                      	CURLOPT_CUSTOMREQUEST => "GET",
									...
									<div class="pagination-content text-center">
										<ul>
											<!-- first page -->
                      						<?php if($page >= 3){ ?>
						                        <li class="page-item">
						                          <a class="page-link" href="?category_id=<?php echo $catid ?>&brand_id=<?php echo $brandid ?>&page=<?php echo $startpage ?>" tabindex="-1" aria-label="Previous">
						                            &laquo;
						                    ...
						                    <?php } ?>
					                      	...
					                      	<?php if($page != $startpage){ ?>
					                        	<li class="page-item"><a class="page-link" href="?category_id=<?php echo $catid ?>&brand_id=<?php echo $brandid ?>&page=<?php echo $previouspage ?>"><i class="fa fa-angle-left"></i></a></li>
					                      	<?php } ?>

					                      	<?php if($page >= 2){ ?>
					                        	<li class="page-item"><a class="page-link" href="?category_id=<?php echo $catid ?>&brand_id=<?php echo $brandid ?>&page=<?php echo $previouspage ?>"><?php echo $previouspage ?></a></li>
					                      	<?php } ?>


					                      	<!-- current page -->
					                      	<li class="page-item active"><a class="page-link" href="?category_id=<?php echo $catid ?>&brand_id=<?php echo $brandid ?>&page=<?php echo $page ?>"><?php echo $page ?></a></li>


					                      	<!-- next page -->
					                      	<?php if($page != $endpage){ ?>
					                        	<li class="page-item"><a class="page-link" href="?category_id=<?php echo $catid ?>&brand_id=<?php echo $brandid ?>&page=<?php echo $nextpage ?>"><?php echo $nextpage ?></a></li>
					                      	<?php } ?>

					                      	<?php if($page != $endpage){ ?>
					                        	<li class="page-item"><a class="page-link" href="?category_id=<?php echo $catid ?>&brand_id=<?php echo $brandid ?>&page=<?php echo $nextpage ?>"><i class="fa fa-angle-right"></i></a></li>
					                      	<?php } ?>
					                      	...
					                      	<?php if($page != $endpage){ ?>
					                        	<li class="page-item">
					                          		<a class="page-link" href="?category_id=<?php echo $catid ?>&brand_id=<?php echo $brandid ?>&page=<?php echo $endpage ?>" aria-label="Next">
